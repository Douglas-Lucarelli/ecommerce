...
def carrinho(request):
    ...
    if itens_pedido.exists():
        ...
        context = {"itens_pedido": None, "pedido": pedido, "cliente_existente": False}  # Mudei aqui
        ...
        if "email" in dados and "senha" in dados and "confirmacao_senha" in dados:
            ...
            if senha == confirmacao_senha:
                ...
                if not criado:
                    ...
                    # Redirecionar após a criação da conta e login
                    response = redirect('loja')

                    # Excluir o cookie id_sessao
                    if request.COOKIES.get("id_sessao"):
                        response.delete_cookie("id_sessao")
...
# TODO Sempre que um úsuario criar uma conta , vamos criar um cliente
